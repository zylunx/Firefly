...
export const en: Translation = {
	...
	[Key.categoriesPageTitle]: "Categories & Tags",
	[Key.tagGraphTitle]: "Tag Relationship Graph",
	[Key.tagGraphCount]: "{count} tags",
	[Key.totalPostsLabel]: "{count} posts in total",
	[Key.highFrequencyTag]: "High frequency",
	[Key.commonTag]: "Common",
	[Key.lowFrequencyTag]: "Low frequency",
