...
export const ja: Translation = {
	...
	[Key.categoriesPageTitle]: "カテゴリとタグ",
	[Key.tagGraphTitle]: "タグ関係グラフ",
	[Key.tagGraphCount]: "{count} 個のタグ",
	[Key.totalPostsLabel]: "合計 {count} 投稿",
	[Key.highFrequencyTag]: "高頻度タグ",
	[Key.commonTag]: "一般タグ",
	[Key.lowFrequencyTag]: "低頻度タグ",
