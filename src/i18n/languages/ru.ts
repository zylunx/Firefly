...
export const ru: Translation = {
	...
	[Key.categoriesPageTitle]: "Категории и теги",
	[Key.tagGraphTitle]: "Граф связей тегов",
	[Key.tagGraphCount]: "{count} тегов",
	[Key.totalPostsLabel]: "Всего {count} постов",
	[Key.highFrequencyTag]: "Частые теги",
	[Key.commonTag]: "Обычные теги",
	[Key.lowFrequencyTag]: "Редкие теги",
	...
	[Key.applyFriend]: "Подать заявку",
	[Key.howToApply]: "Как подать заявку",
	[Key.continueApply]: "Продолжить",
	[Key.cancel]: "Отмена",
