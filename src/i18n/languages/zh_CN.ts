...
export const zh_CN: Translation = {
	...
	[Key.categoriesPageTitle]: "分类标签",
	[Key.tagGraphTitle]: "标签关系图谱",
	[Key.tagGraphCount]: "{count} 个标签",
	[Key.totalPostsLabel]: "共 {count} 篇文章",
	[Key.highFrequencyTag]: "高频标签",
	[Key.commonTag]: "常用标签",
	[Key.lowFrequencyTag]: "低频标签",
	...
	[Key.applyFriend]: "申请友链",
	[Key.howToApply]: "如何申请",
	[Key.continueApply]: "继续申请",
	[Key.cancel]: "取消",
	[Key.guestbook]: "留言",
