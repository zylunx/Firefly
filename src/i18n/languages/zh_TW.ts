...
export const zh_TW: Translation = {
	...
	[Key.categoriesPageTitle]: "分類標籤",
	[Key.tagGraphTitle]: "標籤關係圖譜",
	[Key.tagGraphCount]: "{count} 個標籤",
	[Key.totalPostsLabel]: "共 {count} 篇文章",
	[Key.highFrequencyTag]: "高頻標籤",
	[Key.commonTag]: "常用標籤",
	[Key.lowFrequencyTag]: "低頻標籤",
	...
	[Key.applyFriend]: "申請友鏈",
	[Key.howToApply]: "如何申請",
	[Key.continueApply]: "繼續申請",
	[Key.cancel]: "取消",
	[Key.guestbook]: "留言",
